...
- evaluation results stored in `test_code/` as `pred_density.npy`, `isosurface_pred.png`, and the quantitative comparison table `evaluation_metrics.png`
...
The following table summarizes the reconstruction quality for the four synthetic cases. Density RMSE and MAE measure voxel-wise density errors, Dice and IoU measure the overlap between the predicted and reference anomalous bodies, centroid and depth errors measure geometric localization, and volume recovery and density-amplitude errors quantify the recovered size and contrast.

<p align="center">
  <img src="test_code/evaluation_metrics.png" width="100%" alt="Quantitative evaluation metrics for the four synthetic density models.">
</p>
<p align="center"><em>Quantitative comparison of the one-prism, one-two-prisms, one-two-staircase, and inverted-pyramid models.</em></p>
